    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 pr-5 mb-5 mb-lg-0 wow fadeInLeft">
                ...
                <img src="{{asset('asset3')}}/about.jpg" class="about-img-small position-relative w-100" alt="">
            </div>
            <div class="col-lg-6 pl-6">
                <div class="main-title text-lg-left offset-md-1 mb-0 wow fadeInUp" data-wow-delay="300ms">
                    ...
                    <h2 class="wow fadeInUp font-weight-light" data-wow-delay="400ms"> Kami Hadir <span class="color-pink">Membantu </span> Anda</h2>
                    ...
                    <a href="{{asset('')}}javascript:void(0)" class="btn-setting color-black btn-hvr-up btn-yellow btn-hvr-pink text-white link wow fadeInUp" data-wow-delay="700ms">learn more</a>
                </div>
            </div>
        </div>
    </div>
