    ...
    <form method="POST" action="pas" class="">
        ...
        <div class="card mb-3">
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">Silahkan Edit Project</h5>
                        <div class="mb-3">
                            <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="input-group mb-3">
                                                <input id="thumbnail" class="img{{$item->id}} form-control" type="text"
                                                    ...
                                                    aria-describedby="button-addon2" value="{{$item->Img}}">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                    ...
                                    <input type="checkbox" class="btn-check" id="btncheck{{$it->id}}" autocomplete="off"
                                        name="{{$key}}" value="{{$it->Nama_Filter}}">
